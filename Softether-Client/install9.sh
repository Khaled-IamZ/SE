...
/etc/rc.d/init.d/vpnclient start
cd /usr/local/vpnclient
echo ---------------------------------------------
...
echo ---------------Commands----------------------
echo /etc/rc.d/init.d/vpnclient start - to start
echo /etc/rc.d/init.d/vpnclient restart - to restart
echo /etc/rc.d/init.d/vpnclient stop - to stop
echo ---------------------------------------------
