...
mv vpn-server.sh /etc/rc.d/init.d/vpnserver
cd /etc/rc.d/init.d/
chmod 755 vpnserver
...
echo ---------------Commands----------------------
echo /etc/rc.d/init.d/vpnserver start - to start
echo /etc/rc.d/init.d/vpnserver restart - to restart
echo /etc/rc.d/init.d/vpnserver stop - to stop
echo ---------------------------------------------
#End of script
